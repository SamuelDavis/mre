...
export type AssetPath = `/${string}.jpg`;
type DateString = `${number}-${number}-${number}`;
type HttpString = `http${string}`;

export type MovieSearchResult = {
  adult: boolean;
  backdrop_path: AssetPath;
  genre_ids: MovieGenre["id"][];
  id: number;
...
export type PersonSearchResult = {
  ...
  known_for: (TvSeriesSearchResult | MovieSearchResult)[];
};

interface SearchResultTypes {
  movie: MovieSearchResult;
  tv: TvSeriesSearchResult;
  person: PersonSearchResult;
}

export type MultiSearchResult = {
  [MediaType in keyof SearchResultTypes]: {
    media_type: MediaType;
  } & SearchResultTypes[MediaType];
}[keyof SearchResultTypes];
...
export type SearchResults<Result extends SearchResult = SearchResult> =
  Paginated<Result>;
...
export type PersonDetails = {
  ...
  biography: string;
  birthday: DateString;
  deathday: null | DateString;
  gender: number;
  homepage: null | HttpString;
  id: number;
  imdb_id: string;
  known_for_department: Department;
  name: string;
...
export type MovieCrewCredit<J extends Job = Job> = {
  adult: boolean;
  gender: number;
  id: number;
  known_for_department: Department;
...
export type TvSeriesCastCredit = {
  adult: boolean;
  backdrop_path: AssetPath;
  genre_ids: TvGenre["id"][];
  id: number;
...
export type TvSeriesCrewCredit<J extends Job = Job> = {
  adult: boolean;
  gender: number;
  id: number;
  known_for_department: Department;
...
export type MovieCastCreditDetails<J extends Job = Job> = {
  credit_type: string & ("creator" | "cast" | "crew");
  department: J["department"];
  job: J["name"];
  media: {
    adult: boolean;
...
export type MovieCrewCreditDetails<J extends Job = Job> = {
  credit_type: "crew";
  department: J["department"];
  job: J["name"];
  media: {
...
export type TvSeriesCastCreditDetails<J extends Job = Job> = {
  credit_type: "cast";
  department: J["department"];
  job: J["name"];
  media: {
...
export type TvSeriesCrewCreditDetails<J extends Job = Job> = {
  credit_type: "crew";
  department: J["department"];
  job: J["name"];
  media: {
...
export type TvSeriesCreatorCreditDetails<J extends Job = Job> = {
  credit_type: "creator";
  department: J["department"];
  job: J["name"];
  media: {
...
type MovieGenre = (typeof MovieGenres)[number];
...
type TvGenre = (typeof TvGenres)[number];
...
export type AssetSizes = (typeof ImageConfiguration)["sizes"];
...
type Department = (typeof Jobs)[number]["department"];
type Job = {
  [Dept in Department]: {
    name: Extract<(typeof Jobs)[number], { department: Dept }>["jobs"][number];
    department: Dept;
  };
}[Department];
